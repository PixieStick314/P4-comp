...
public class RogueLangParser extends Parser {
	...
	public static final int
		...
		RULE_params = 13, RULE_param = 14, RULE_args = 15, RULE_randomInt = 16, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"bsp", "params", "param", "args", "randomInt", "randomChoice", "enumDecl", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'print'", "'='", "'int'", "'string'", "'bool'", "'double'", "'date'", 
	...
	@SuppressWarnings("CheckReturnValue")
	public static class RandomIntContext extends ParserRuleContext {
		public OpenParenthContext openParenth() {
			return getRuleContext(OpenParenthContext.class,0);
		}
		public List<TerminalNode> INT() { return getTokens(RogueLangParser.INT); }
		public TerminalNode INT(int i) {
			return getToken(RogueLangParser.INT, i);
		}
		...
		public RandomIntContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_randomInt; }
	}

	public final RandomIntContext randomInt() throws RecognitionException {
		RandomIntContext _localctx = new RandomIntContext(_ctx, getState());
		enterRule(_localctx, 32, RULE_randomInt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(214);
	...
	public static class ExprContext extends ParserRuleContext {
		...
		public TerminalNode DOUBLE() { return getToken(RogueLangParser.DOUBLE, 0); }
		public TerminalNode TRUE() { return getToken(RogueLangParser.TRUE, 0); }
		public TerminalNode FALSE() { return getToken(RogueLangParser.FALSE, 0); }
		public RandomIntContext randomInt() {
			return getRuleContext(RandomIntContext.class,0);
		}
