...
public interface RogueLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link RogueLangParser#randomInt}.
	 * @param ctx the parse tree
	 */
	void enterRandomInt(RogueLangParser.RandomIntContext ctx);
	/**
	 * Exit a parse tree produced by {@link RogueLangParser#randomInt}.
	 * @param ctx the parse tree
	 */
	void exitRandomInt(RogueLangParser.RandomIntContext ctx);
	/**
