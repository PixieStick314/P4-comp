...
class RogueLangVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by RogueLangParser#hashTable.
    def visitHashTable(self, ctx:RogueLangParser.HashTableContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by RogueLangParser#keyValuePair.
    def visitKeyValuePair(self, ctx:RogueLangParser.KeyValuePairContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by RogueLangParser#hashKey.
